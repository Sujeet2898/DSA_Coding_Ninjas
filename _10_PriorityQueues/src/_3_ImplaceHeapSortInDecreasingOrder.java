public class _3_ImplaceHeapSortInDecreasingOrder {
}
Q.  Code - Implace Heap sort
        ----------------------------------------------
...
--------------------------------------------------------------
    public static void main(String[] args) {
        ...
        // Min Priority Queue gives Sorted Heap in decreasing order
        for (int i = 0; i < arr.length; i++){
...
----------------------------------------------------------
        ...
        9 6 5 2 1 0     // Conversion of Heap into Sorted Heap
