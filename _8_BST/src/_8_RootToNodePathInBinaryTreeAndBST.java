public class _8_RootToNodePathInBinaryTreeAndBST {
}
...
public class BinaryTreeUse {
    ...
    public static ArrayList<Integer> getRootToNode(BinaryTreeNode<Integer> root, int data) {
        ...
        // Checking leftOutput is null or not and adding rootData to ArrayList
        ...
        // Checking rightOutput is null or not and adding rootData to ArrayList
    ...
    public static void main(String[] args) {
        ...
        printLevelWise(root);
        System.out.println();
        System.out.println(getRootToNode(root,6));
    }
}
---------------------------------------------
        Input:
