public class _18_MinimumAndMaximumInTheBinaryTree {
}
    Q.  Minimum and Maximum in the Binary Tree
        ----------------------------------------------
...
public class BinaryTreeUse {
    ...
    public static Pair<Integer,Integer> getMinMax(BinaryTreeNode<Integer> root){
        ...
        Pair<Integer, Integer> leftPair = getMinMax(root.left);
        Pair<Integer, Integer> rightPair = getMinMax(root.right);
    ...
    public static void main(String[] args) {
        ...
        printLevelWise(root);
        System.out.println();
        Pair<Integer, Integer> output = getMinMax(root);
